    ...
    return (
        <>
            ...
            <div className="relative min-h-screen w-full">
                ...
                <div className="absolute px-4 md:left-20 top-1/2 transform -translate-y-1/2 text-left space-y-4 w-full md:w-auto">
            ...
            {/* About Us Section */}
            <div className="bg-black min-h-screen w-full relative py-12 md:py-0">
            ...
            <div className="bg-black min-h-screen w-full relative py-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[5, 6, 7, 8].map((num) => (
                            <div key={num} className="flex justify-center">
                                <Image src={`/img${num}.png`} alt="img" width={250} height={250} className="w-full max-w-[250px]" />
                            </div>
                        ))}
                    </div>
                </div>
