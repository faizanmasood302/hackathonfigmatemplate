    ...
    <header className="bg-black text-white">
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <nav className="hidden md:flex space-x-6">
          <Link href="/home"  className="text-orange-500 hover:text-white">Home</Link>
        ...
        <div className="flex space-x-4 items-center">
          ...
          <button aria-label="User" className="hover:text-orange-500">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <button aria-label="Cart" className="hover:text-orange-500">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <Image src="/header.png" alt="header"  width={1960} height={325} className='relative bg-black opacity-90' />
      {/* Hero Section */}
